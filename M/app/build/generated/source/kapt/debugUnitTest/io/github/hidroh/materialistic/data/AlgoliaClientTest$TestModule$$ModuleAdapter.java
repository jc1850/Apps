 ...
 */
public final class AlgoliaClientTest$TestModule$$ModuleAdapter extends ModuleAdapter<AlgoliaClientTest.TestModule> {
  private static final String[] INJECTS = { "members/io.github.hidroh.materialistic.data.AlgoliaClientTest", "members/io.github.hidroh.materialistic.data.AlgoliaClient", };

  private static final Class<?>[] STATIC_INJECTIONS = { };

  private static final Class<?>[] INCLUDES = { };

  public AlgoliaClientTest$TestModule$$ModuleAdapter() {
    super(AlgoliaClientTest.TestModule.class, INJECTS, STATIC_INJECTIONS, true /*overrides*/, INCLUDES, true /*complete*/, false /*library*/);
  }

  @Override
  public AlgoliaClientTest.TestModule newModule() {
    return new AlgoliaClientTest.TestModule();
  }
   ...
   */
  @Override
  public void getBindings(BindingsGroup bindings, AlgoliaClientTest.TestModule module) {
  ...
  public static final class ProvideHackerNewsClientProvidesAdapter extends ProvidesBinding<ItemManager> {
    private final AlgoliaClientTest.TestModule module;

    public ProvideHackerNewsClientProvidesAdapter(AlgoliaClientTest.TestModule module) {
      super("@javax.inject.Named(value=hn)/io.github.hidroh.materialistic.data.ItemManager", IS_SINGLETON, "io.github.hidroh.materialistic.data.AlgoliaClientTest.TestModule", "provideHackerNewsClient");
      this.module = module;
      setLibrary(false);
    }
  ...
  public static final class ProvideMainThreadSchedulerProvidesAdapter extends ProvidesBinding<Scheduler> {
    ...
    public ProvideMainThreadSchedulerProvidesAdapter(AlgoliaClientTest.TestModule module) {
      super("@javax.inject.Named(value=main)/rx.Scheduler", IS_SINGLETON, "io.github.hidroh.materialistic.data.AlgoliaClientTest.TestModule", "provideMainThreadScheduler");
      this.module = module;
      setLibrary(false);
    }
  ...
  public static final class ProvideRestServiceFactoryProvidesAdapter extends ProvidesBinding<RestServiceFactory> {
    ...
    public ProvideRestServiceFactoryProvidesAdapter(AlgoliaClientTest.TestModule module) {
      super("io.github.hidroh.materialistic.data.RestServiceFactory", IS_SINGLETON, "io.github.hidroh.materialistic.data.AlgoliaClientTest.TestModule", "provideRestServiceFactory");
      this.module = module;
      setLibrary(false);
    }
