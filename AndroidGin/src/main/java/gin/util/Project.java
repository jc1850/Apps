...
public class Project {
    ...
    private static String getMethodSignature(File srcDir, String methodName, String className, int lineNumber) {
        ...
        unit = parser.parse(String.valueOf(sourceFile)).getResult().get();
