...
public abstract class ParetoPop {
    ...
    public ParetoPop(int noObj, ArrayList<Integer> fitnessDirs){
        this.population = new ArrayList<>();
        this.noObj = noObj;
        this.fitnessDirs = fitnessDirs;
    }

    public ParetoPop(ParetoPop p, ParetoPop q){
        if (p.noObj != q.noObj){
    ...
    public abstract void addInd(Patch patch, ArrayList<Double> fitnesses);
