...
public final class BookmarkExporter {
    ...
    @NonNull
    public static Completable exportBookmarksToFile(@NonNull final List<Bookmark.Entry> bookmarkList, @NonNull final File file) {
    ...
    public static List<Bookmark.Entry> importBookmarksFromFileStream(@NonNull InputStream inputStream) throws Exception {
        ...
        try {
            ...
            while ((line = bookmarksReader.readLine()) != null) {
                ...
                final Bookmark.Entry entry = new Bookmark.Entry(object.getString(KEY_URL), object.getString(KEY_TITLE), object.getInt(KEY_ORDER), WebPageKt.asFolder(folderName));
                bookmarks.add(entry);
            }
            return bookmarks;
        } finally {
