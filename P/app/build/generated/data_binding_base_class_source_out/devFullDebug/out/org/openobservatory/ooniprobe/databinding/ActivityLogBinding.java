...
public final class ActivityLogBinding implements ViewBinding {
  ...
  private ActivityLogBinding(@NonNull ConstraintLayout rootView, @NonNull RecyclerView recyclerView,
      @NonNull Spinner spinnerTag) {
  ...
  public static ActivityLogBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.spinnerTag;
      Spinner spinnerTag = ViewBindings.findChildViewById(rootView, id);
      if (spinnerTag == null) {
        break missingId;
      }

      return new ActivityLogBinding((ConstraintLayout) rootView, recyclerView, spinnerTag);
    }
