...
public final class FragmentContentBinding implements ViewBinding {
  ...
  @NonNull
  public final FrameLayout subContent;

  @NonNull
  public final Toolbar toolbar;

  private FragmentContentBinding(@NonNull LinearLayout rootView, @NonNull FrameLayout subContent,
  ...
  public static FragmentContentBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.subContent;
      FrameLayout subContent = ViewBindings.findChildViewById(rootView, id);
      if (subContent == null) {
        break missingId;
      }
      ...
      return new FragmentContentBinding((LinearLayout) rootView, subContent, toolbar);
    }
