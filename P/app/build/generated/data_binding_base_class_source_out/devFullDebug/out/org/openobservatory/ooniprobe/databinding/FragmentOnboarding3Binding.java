...
public final class FragmentOnboarding3Binding implements ViewBinding {
  ...
  @NonNull
  public final TextView defaultSettingsTitle;
  ...
  private FragmentOnboarding3Binding(@NonNull LinearLayout rootView, @NonNull TextView bullet1,
      @NonNull TextView bullet2, @NonNull TextView bullet3, @NonNull TextView defaultSettingsTitle,
      @NonNull Button master, @NonNull TextView paragraph, @NonNull Button slave) {
    this.rootView = rootView;
    this.bullet1 = bullet1;
    this.bullet2 = bullet2;
    this.bullet3 = bullet3;
    this.defaultSettingsTitle = defaultSettingsTitle;
    this.master = master;
  ...
  public static FragmentOnboarding3Binding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.default_settings_title;
      TextView defaultSettingsTitle = ViewBindings.findChildViewById(rootView, id);
      if (defaultSettingsTitle == null) {
        break missingId;
      }
      ...
      return new FragmentOnboarding3Binding((LinearLayout) rootView, bullet1, bullet2, bullet3,
          defaultSettingsTitle, master, paragraph, slave);
    }
