...
public class Onboarding3Fragment_ViewBinding implements Unbinder {
  private Onboarding3Fragment target;
  ...
  @UiThread
  public Onboarding3Fragment_ViewBinding(final Onboarding3Fragment target, View source) {
    this.target = target;
    ...
    target.paragraph = Utils.findRequiredViewAsType(source, R.id.paragraph, "field 'paragraph'", TextView.class);
  ...
  @CallSuper
  public void unbind() {
    Onboarding3Fragment target = this.target;
