...
public final class ItemMainAppbuildBinding implements ViewBinding {
  @NonNull
  ...
  private ItemMainAppbuildBinding(@NonNull RelativeLayout rootView,
  ...
  @NonNull
  public static ItemMainAppbuildBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ItemMainAppbuildBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.item_main_appbuild, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ItemMainAppbuildBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemMainAppbuildBinding((RelativeLayout) rootView, buildRunTypeFinished,
