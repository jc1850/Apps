...
public final class MainActivity extends AppCompatActivity implements MainAsyncResponse {
    ...
    protected TextView signalStrength;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        testing = new boolean[]{false,false,false,false,false,false,false,false,false,false,false,false};
     ...
     */
    protected void setupHostsAdapter() {
        setAnimations();
     ...
     */
    protected void setupHostDiscovery() {
    ...
    public void setHostListListener(){
     ...
     */
    protected void getNetworkInfo(NetworkInfo info) {
        setupMac();
        getExternalIp();
